...
const pool = new Pool({
  ...
  database: "postgres", // name of db you wanna connect with, in my case it was test cause i called it that
  password: "admin", //im not giving you my password, will be an env when pushed to GH
